...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen w-full bg-[#071B34] lg:bg-slate-100 flex flex-col lg:flex-row overflow-x-hidden font-sans">
      {/* LEFT COLUMN: Realistic Hospital Visual & Brand Showcase (55% Desktop) */}
      <div className="relative lg:w-[55%] min-h-[220px] lg:min-h-screen bg-[#071B34] flex flex-col justify-between p-6 sm:p-12 overflow-hidden shrink-0">
      ...
      {/* RIGHT COLUMN: High-Contrast White Auth Card Container (45% Desktop) */}
      <div className="flex-1 min-h-[calc(100vh-220px)] lg:min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-8 lg:p-12">
        <div className="w-full max-w-[430px] bg-white rounded-3xl p-6 sm:p-10 shadow-2xl border border-slate-200">
          {children}
        </div>
      </div>
    </div>
