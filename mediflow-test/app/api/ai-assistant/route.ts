...
export async function POST(req: Request) {
  try {
    ...
    if (lower === "hello" || lower === "hi" || lower === "hey" || lower.startsWith("hello ") || lower.startsWith("hi ")) {
      return NextResponse.json({
        reply: `Hello! I'm Mediflow-AI, your hospital operations and clinical workflow assistant for ${HOSPITAL_NAME}. What would you like to check today?`,
    ...
    if (lower.includes("alert") || lower.includes("emergency") || lower.includes("critical")) {
      ...
      const reply = `### Active Critical Alerts — ${HOSPITAL_NAME}\n\n${
